...
public class ModernChooseWheel implements IChooseWheel {
    ...
    private final ResourceLocation TEXTURE = ((ClientConfig) EmoteInstance.config).dark.get() ? CommonData.newIdentifier("textures/gui/fastchoose_dark_new.png") : CommonData.newIdentifier("textures/gui/fastchoose_light_new.png");
